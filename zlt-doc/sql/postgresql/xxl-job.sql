CREATE SCHEMA IF NOT EXISTS "xxl-job";
Set schema 'xxl-job';

-- SQLINES DEMO *** -----------
-- SQLINES DEMO *** or XXL_JOB_QRTZ_JOB_DETAILS
-- SQLINES DEMO *** -----------
DROP TABLE IF EXISTS XXL_JOB_QRTZ_JOB_DETAILS CASCADE;
...
-- SQLINES DEMO *** -----------
DROP TABLE IF EXISTS XXL_JOB_QRTZ_TRIGGERS CASCADE;
-- SQLINES LICENSE FOR EVALUATION USE ONLY
...
-- SQLINES LICENSE FOR EVALUATION USE ONLY
DROP SEQUENCE IF EXISTS XXL_JOB_QRTZ_TRIGGER_GROUP_seq;
...
-- SQLINES LICENSE FOR EVALUATION USE ONLY
DROP SEQUENCE IF EXISTS XXL_JOB_QRTZ_TRIGGER_INFO_seq;
...
-- SQLINES LICENSE FOR EVALUATION USE ONLY
DROP SEQUENCE IF EXISTS XXL_JOB_QRTZ_TRIGGER_LOG_seq;
...
-- SQLINES LICENSE FOR EVALUATION USE ONLY
DROP SEQUENCE IF EXISTS XXL_JOB_QRTZ_TRIGGER_LOGGLUE_seq;
...
-- SQLINES LICENSE FOR EVALUATION USE ONLY
DROP SEQUENCE IF EXISTS XXL_JOB_QRTZ_TRIGGER_REGISTRY_seq;
